        ...
        Row {
            ...
            Row {
                ...
                IconButton {
                    ...
                    anchors.verticalCenter: parent.verticalCenter
                    opacity: (player && player.canGoPrevious) ? 1.0 : 0.3
                ...
                IconButton {
                    ...
                    textColor: isHoveredOrHighlighted ? ThemeBackend.text : (mediaWidgetRoot.isCompact ? ThemeBackend.subtext0 : ThemeBackend.overlay2)
                    anchors.verticalCenter: parent.verticalCenter
                    // BITE-OS: reflect MPRIS capability. Chromium reports
                    // CanGoNext=false for a standalone video (no queue), so the
                    // click is a no-op -- without this the button looked live and
                    // read as broken software.
                    opacity: (player && player.canGoNext) ? 1.0 : 0.3
