...
Item {
    ...
    property var tabsModel: [
        ...
        { id: "BITE-OS", key: "biteos", name: "BITE-OS", icon: "", file: "BiteOsTab.qml" },
        { id: "Keybinds", key: "keybinds", name: "Keybinds", icon: "󰌌", file: "KeybindsTab.qml" },
        { id: "BiteWidgets", key: "bitewidgets", name: "Widgets", icon: "󰕰", file: "BiteWidgetsTab.qml" },
                ...
                ColumnLayout {
                    ...
                    Flickable {
                        ...
                        ColumnLayout {
                            ...
                            Rectangle {
                                ...
                                RowLayout {
                                    ...
                                    IconButton {
                                        ...
                                        buttonIcon: "󰋜"
                                        // BITE-OS: offset -1 was tuned for real Iosevka; BITE-OS renders
                                        // icons with Symbols Nerd Font, where this glyph is already centred.
                                        iconOffsetX: 0
                                            ...
                                            Rectangle {
                                                ...
                                                RowLayout {
                                                    ...
                                                    IconButton {
                                                        ...
                                                        cornerRadius: ThemeBackend.borderRadius
                                                        buttonIcon: "󰃠"
                                                        // BITE-OS: offset -2 was tuned for real Iosevka; BITE-OS renders
                                                        // icons with Symbols Nerd Font, where this glyph is already centred.
                                                        iconOffsetX: 0
                            ...
                            // Upstream 2.1.5 hard-codes one sidebar button per tab (no
                            // Repeater), so our two tabsModel entries need real buttons
                            // here; About moves from index 11 to 13 to match tabsModel.
                            Rectangle {
                                id: tabBiteOs
                                Layout.fillWidth: true
                                Layout.preferredHeight: root.s(44)
                                ...
                                color: tabBiteOsMa.containsMouse && !isDirectActive ? Qt.alpha(ThemeBackend.surface1, 0.5) : "transparent"
                                Behavior on color { ColorAnimation { duration: 150 } }

                                scale: tabBiteOsMa.pressed ? 0.98 : 1.0
                                Behavior on scale { NumberAnimation { duration: 250; easing.type: Easing.OutQuint } }

                                RowLayout {
                                    anchors.fill: parent
                                    anchors.leftMargin: root.s(10) + (tabBiteOs.isDirectActive ? root.s(4) : 0)
                                    anchors.rightMargin: root.s(14)
                                    spacing: root.s(10)
                                    ...
                                    Text {
                                        text: I18n.t("guide.tabs.biteos", "BITE-OS")
                                        font.family: ThemeBackend.fontFamily
                                        font.weight: tabBiteOs.isDirectActive ? Font.Bold : Font.Medium
                                        font.pixelSize: root.s(13)
                                        color: tabBiteOs.isDirectActive 
                                            ? ThemeBackend.crust 
                                            : (tabBiteOsMa.containsMouse ? ThemeBackend.text : ThemeBackend.subtext0)
                                        Layout.fillWidth: true
                                        Layout.alignment: Qt.AlignVCenter
                                        elide: Text.ElideRight
                                        Behavior on color { ColorAnimation { duration: 150 } }
                            ...
                            Rectangle {
                                ...
                                property bool isDirectActive: root.currentTab === 13

                                color: tabBiteWidgetsMa.containsMouse && !isDirectActive ? Qt.alpha(ThemeBackend.surface1, 0.5) : "transparent"
                                Behavior on color { ColorAnimation { duration: 150 } }

                                scale: tabBiteWidgetsMa.pressed ? 0.98 : 1.0
                                Behavior on scale { NumberAnimation { duration: 250; easing.type: Easing.OutQuint } }

                                RowLayout {
                                    anchors.fill: parent
                                    anchors.leftMargin: root.s(10) + (tabBiteWidgets.isDirectActive ? root.s(4) : 0)
                                    anchors.rightMargin: root.s(14)
                                    spacing: root.s(10)
                                    ...
                                    Text {
                                        text: "Widgets"
                                        font.family: ThemeBackend.fontFamily
                                        font.weight: tabBiteWidgets.isDirectActive ? Font.Bold : Font.Medium
                                        font.pixelSize: root.s(13)
                                        color: tabBiteWidgets.isDirectActive 
                                            ? ThemeBackend.crust 
                                            : (tabBiteWidgetsMa.containsMouse ? ThemeBackend.text : ThemeBackend.subtext0)
                                        Layout.fillWidth: true
                                        Layout.alignment: Qt.AlignVCenter
                                        elide: Text.ElideRight
                                        Behavior on color { ColorAnimation { duration: 150 } }
                            ...
                            Rectangle {
                                ...
                                property bool isDirectActive: root.currentTab === 14
                    ...
                    ClickButton {
                        // BITE-OS: hard-disabled. This prompt leads to the About
                        // tab's updater, which on BITE-OS would re-run upstream's
                        // install.sh and wipe this rice. Updates go via Super+U.
                        visible: false
                        Layout.fillWidth: true
