...
Item {
    ...
    property var tabNames: ["General", "Weather", "Keybinds", "Monitors", "Startup", "Dots"]
    property var tabIcons: ["󰒓", "󰖐", "󰌌", "󰍹", "󰐥", "󰏘"]
    property var tabColors: ["teal", "blue", "peach", "green", "mauve", "red"]
            ...
            ColumnLayout {
                ...
                Item {
                    ...
                    Loader {
                        id: dotsLoader
                        anchors.fill: parent
                        active: root.tab5Loaded
                        sourceComponent: dotsTabComponent
    ...
    Component {
        ...
        Item {
            ...
            property string activeDot: "ilyamiro"

            function refreshActive() { activeDotProc.running = true; }
            function switchDot(name) {
                if (name === dotsTabRoot.activeDot) return;
                Quickshell.execDetached(["bash", Quickshell.env("HOME") + "/.config/glitch/bin/dots-switch.sh", name]);
                Quickshell.execDetached(["notify-send", "-a", "BITE-OS", "Dots", "Switching to " + name + "…"]);
            }
            ...
            Process {
                id: activeDotProc
                command: ["bash", "-c", "cat \"$HOME/.local/state/bite-os/active-shell\" 2>/dev/null || echo ilyamiro"]
                stdout: StdioCollector {
                    onStreamFinished: {
                        let v = this.text.trim();
                        if (v === "caelestia" || v === "ilyamiro") dotsTabRoot.activeDot = v;
                    }
                }
            }
            Timer { interval: 2500; repeat: true; running: true; onTriggered: dotsTabRoot.refreshActive() }
            ...
            Flickable {
                ...
                anchors.fill: parent
                contentWidth: width
                contentHeight: dotsCol.implicitHeight + root.s(100)
                boundsBehavior: Flickable.StopAtBounds
                clip: true
                ...
                ColumnLayout {
                    ...
                    Text {
                        ...
                        text: "Two complete desktops. Swap live — every swap auto-backs-up your config, and a watchdog rescues you if a shell fails to come up."
                    ...
                    Repeater {
                        ...
                        delegate: Rectangle {
                            id: dotCard
                            property bool isActive: model.key === dotsTabRoot.activeDot
                            property color accent: model.key === "ilyamiro" ? root.mauve : root.green
                            Layout.fillWidth: true
                            Layout.preferredHeight: dotCardCol.implicitHeight + root.s(28)
                            radius: root.s(10)
                            color: root.surface0
                            border.width: isActive ? 2 : 1
                            border.color: isActive ? accent : root.surface1
                            Behavior on border.color { ColorAnimation { duration: 200 } }
                            ...
                            ColumnLayout {
                                ...
                                RowLayout {
                                    ...
                                    Rectangle {
                                        ...
                                        color: dotCard.accent
                                    }
                                    Text {
                                        text: model.title
                                        font.family: "JetBrains Mono"; font.weight: Font.Bold
                                        font.pixelSize: root.s(13); color: root.text
                                    }
                                    Item { Layout.fillWidth: true }
                                    ...
                                    Rectangle {
                                        ...
                                        Layout.preferredWidth: dotActionRow.implicitWidth + root.s(20)
                                        radius: root.s(6)
                                        color: dotCard.isActive
                                            ? Qt.alpha(dotCard.accent, 0.18)
                                            : (dotSwitchMa.containsMouse ? dotCard.accent : root.surface1)
                                        border.width: 1
                                        border.color: dotCard.isActive ? dotCard.accent : root.surface2
                                        Behavior on color { ColorAnimation { duration: 150 } }
                                        ...
                                        RowLayout {
                                            ...
                                            spacing: root.s(6)
                                            Text {
                                                text: dotCard.isActive ? "󰄬" : "󰓡"
                                                font.family: "Iosevka Nerd Font"; font.pixelSize: root.s(12)
                                                color: dotCard.isActive ? dotCard.accent
                                                    : (dotSwitchMa.containsMouse ? root.base : root.text)
                                            }
                                            Text {
                                                text: dotCard.isActive ? "ACTIVE" : "Switch"
                                                font.family: "JetBrains Mono"; font.weight: Font.Bold
                                        ...
                                        MouseArea {
                                            ...
                                            anchors.fill: parent
                                            hoverEnabled: true
                                            enabled: !dotCard.isActive
                                            cursorShape: dotCard.isActive ? Qt.ArrowCursor : Qt.PointingHandCursor
                                            onClicked: dotsTabRoot.switchDot(model.key)
                                        }
                                    }
                                }
                    ...
                    // ── lockout protection / security ──────────────────
                    Rectangle {
                        Layout.fillWidth: true
                        Layout.topMargin: root.s(4)
                        Layout.preferredHeight: secCol.implicitHeight + root.s(28)
                        radius: root.s(10)
                        color: root.surface0
                        border.width: 1
                        border.color: Qt.alpha(root.red, 0.5)
                        ...
                        ColumnLayout {
                            ...
                            RowLayout {
                                ...
                                Text {
                                    ...
                                    font.family: "JetBrains Mono"; font.weight: Font.Bold
                                    font.pixelSize: root.s(11); color: root.text
                                }
                            }
                            Text {
                                Layout.fillWidth: true
                                text: "Swapping away from caelestia arms a 30-second watchdog. If the new desktop's shell isn't alive after 30s, it auto-reverts to caelestia — you physically can't get stuck on a black screen."
                                wrapMode: Text.WordWrap
                                font.family: "JetBrains Mono"; font.pixelSize: root.s(10)
                                color: root.subtext0
                            }
                            ...
                            Rectangle {
                                ...
                                radius: root.s(8)
                                color: revertMa.containsMouse ? root.red : root.surface1
                                border.width: 1
                                ...
                                RowLayout {
                                    ...
                                    Text {
                                        ...
                                        color: revertMa.containsMouse ? root.base : root.red
                                    }
                                    Text {
                                        text: "Emergency revert → caelestia"
                                        font.family: "JetBrains Mono"; font.weight: Font.Bold
                                        font.pixelSize: root.s(10)
                                        color: revertMa.containsMouse ? root.base : root.red
                                    }
                                ...
                                MouseArea {
                                    ...
                                    hoverEnabled: true
                                    cursorShape: Qt.PointingHandCursor
                                    onClicked: dotsTabRoot.switchDot("caelestia")
                                }
                            }
                        }
                    }
                    ...
                    Rectangle {
                        Layout.fillWidth: true
                        Layout.preferredHeight: kbCol.implicitHeight + root.s(28)
                        radius: root.s(10)
                        color: root.surface0
                        border.width: 1
                        ...
                        ColumnLayout {
                            ...
                            Repeater {
                                model: ListModel {
                                    ListElement { combo: "CTRL + SUPER + D"; act: "Emergency revert to caelestia (works in both desktops)" }
                                    ListElement { combo: "SUPER + BACKSPACE"; act: "Hot-swap to the ilyamiro desktop" }
                                }
                                delegate: RowLayout {
                                    Layout.fillWidth: true
                                    spacing: root.s(10)
                                    Rectangle {
                                        Layout.preferredWidth: comboTxt.implicitWidth + root.s(16)
                                        ...
                                        Text {
                                            ...
                                            text: model.combo
                                            font.family: "JetBrains Mono"; font.weight: Font.Bold
                                            font.pixelSize: root.s(9); color: root.peach
                                        }
                                    }
                                    Text {
                                        Layout.fillWidth: true
