...
Item {
    ...
    Item {
        ...
        height: Math.max(0, root.height - (waveClipBox.visible ? waveClipBox.height : 0))
        clip: true

        Item {
            x: root.contentMargins
            y: root.contentMargins
            width: root.width - 2 * root.contentMargins
            height: root.height - 2 * root.contentMargins
    ...
    Item {
        ...
        Item {
            ...
            x: root.contentMargins
            y: root.contentMargins - (root.height - waveClipBox.height)
            width: root.width - 2 * root.contentMargins
            height: root.height - 2 * root.contentMargins
