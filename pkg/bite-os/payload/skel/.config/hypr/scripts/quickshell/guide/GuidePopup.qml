            ...
            Item {
                ...
                ColumnLayout {
                    ...
                    Rectangle {
                        ...
                        Layout.preferredHeight: root.s(50)
                        radius: root.s(10)
                        color: biteMa.containsMouse ? Qt.alpha(root.surface1, 0.6) : Qt.alpha(root.surface0, 0.4)
                        border.color: biteMa.containsMouse ? root.sky : root.surface1
                        border.width: 1
                        scale: biteMa.pressed ? 0.98 : (biteMa.containsMouse ? 1.01 : 1.0)
                        ...
                        RowLayout {
                            ...
                            Rectangle {
                                ...
                                border.color: root.surface2
                                border.width: 1
                                Text { anchors.centerIn: parent; text: ""; font.family: "Iosevka Nerd Font"; font.pixelSize: root.s(18); color: root.sky }
                            }
                            ...
                            ColumnLayout {
                                ...
                                spacing: root.s(1)
                                Text {
                                    text: "Heavily modified & riced for BITE-OS"
                                    font.family: "JetBrains Mono"
                                    font.weight: Font.Black
                                    font.pixelSize: root.s(12)
                                    color: root.text
                        ...
                        MouseArea {
                            ...
                            hoverEnabled: true
                            cursorShape: Qt.PointingHandCursor
                            onClicked: Quickshell.execDetached(["xdg-open", "https://tiktok.com/@glitchbite404"])
                        }
                    }
